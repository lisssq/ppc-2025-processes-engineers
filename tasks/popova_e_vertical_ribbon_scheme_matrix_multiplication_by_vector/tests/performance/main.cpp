...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, PopovaEMatrixMultiplicationByVectorMPI, PopovaEMatrixMultiplicationByVectorSEQ>(PPC_SETTINGS_popova_e_vertical_ribbon_scheme_matrix_multiplication_by_vector);
